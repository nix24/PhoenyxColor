...
const baseStyles = "glass-panel rounded-xl transition-all duration-300 relative overflow-hidden";
...
>
	...
	<div
		class="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-white/5 to-transparent opacity-50 pointer-events-none rounded-xl"
	></div>
