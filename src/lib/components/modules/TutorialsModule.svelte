<script lang="ts">
    ...
    const tutorials: TutorialSection[] = [
        {
            ...
            description:
                "Learn the basics of PhoenyxColor and navigate the interface",
    ...
    function isCompleted(tutorialId: string) {
        return appStore.state.tutorialState.completedTutorials.includes(
            tutorialId,
        );
    }
</script>
    ...
    {#if !activeTutorial}
        ...
        <div class="mb-8">
            ...
            <p class="text-base-content/70">
                Learn how to use PhoenyxColor effectively with our comprehensive
                tutorials
            </p>
        </div>
                ...
                >
                    <div class="space-y-3">
                        ...
                        <ul class="space-y-1 text-sm text-base-content/70">
                            <li>
                                • Upload reference images by dragging and
                                dropping
                            </li>
                            <li>
                                • Create palettes with the "New Palette" button
                            </li>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-base-content/70">
                            Step {currentStep + 1} of {activeTutorial.steps
                                .length}
                        </p>
                    </div>
                </div>
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                {#each activeTutorial.steps as _, index}
                    <button
                        class="btn btn-circle btn-xs {index === currentStep
                            ? 'btn-primary'
                            : 'btn-outline'}"
