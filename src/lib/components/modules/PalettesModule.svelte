...
<div class="h-full flex flex-col">
	...
	<div class="flex-1 flex flex-col lg:flex-row">
		<!-- Palettes List -->
		<div
			class="w-full lg:w-80 border-b lg:border-b-0 lg:border-r border-base-300 bg-base-100 max-h-96 lg:max-h-none overflow-y-auto"
		>
			<div class="p-4">
				...
				<div class="space-y-3">
					...
					{:else if filteredPalettes.length === 0}
						<div class="text-center py-8 text-base-content/70">
							<Icon icon="material-symbols:search-off" class="h-12 w-12 mx-auto mb-2 opacity-50" />
						...
						<div class="flex items-center space-x-2">
							...
							<div class="dropdown dropdown-end">
								...
								>
									...
									<li>
										<button
											onclick={() => fillPaletteWithHarmony(appStore.activePalette!.id, "triadic")}
											type="button"
										>
						...
						{#each appStore.activePalette.colors as color, index}
							<div class="color-swatch-large">
								...
								<div class="mt-2 text-center">
									<p class="text-sm font-mono text-base-content">
			...
			{:else}
				<div class="flex items-center justify-center h-full">
					<div class="text-center text-base-content/70">
						...
						<button class="btn btn-primary" onclick={() => (showCreateDialog = true)} type="button">
...
{#if showColorPicker}
	<div class="fixed top-16 right-6 z-40 scale-in" style="transform-origin: top right;">
		<AdvancedColorPicker
