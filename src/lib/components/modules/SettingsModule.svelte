<script lang="ts">
    ...
    let localSettings = $state({
        ...
        globalEyedropperEnabled:
            appStore.state.settings.globalEyedropperEnabled,
        autoSave: appStore.state.settings.autoSave,
        autoSaveInterval: appStore.state.settings.autoSaveInterval,
        defaultPngResolution:
            appStore.state.settings.exportPreferences.defaultPngResolution,
        compressionLevel:
            appStore.state.settings.exportPreferences.compressionLevel,
    });
...
<div class="container mx-auto p-6 max-w-4xl">
    ...
    <div class="mb-8">
        ...
        <p class="text-base-content/70">
            Configure your PhoenyxColor experience and preferences
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card bg-base-100 shadow-lg border border-base-300">
            <div class="card-body">
                ...
                <div class="form-control mb-4">
                    ...
                    />
                    <div
                        class="w-full flex justify-between text-xs px-2 text-base-content/60"
                    >
                        <span>3</span>
                        <span class="font-medium"
                            >{localSettings.defaultPaletteSlots}</span
                        >
                        <span>20</span>
                    </div>
                </div>
                ...
                {#if localSettings.autoSave}
                    <div class="form-control">
                        <label class="label" for="save-interval">
                            <span class="label-text font-medium"
                                >Auto Save Interval (minutes)</span
                            >
                        </label>
                        <input
                            id="save-interval"
        ...
        <div class="card bg-base-100 shadow-lg border border-base-300">
            <div class="card-body">
                ...
                <!-- Always on Top -->
                <div
                    class="form-control mb-4 tooltip"
                    data-tip="Desktop app feature"
                >
                    <label class="label cursor-not-allowed">
                        <span class="label-text font-medium opacity-50"
                            >Always on Top</span
                        >
                        <input
                            type="checkbox"
            ...
            <div class="card-body">
                ...
                <div class="form-control">
                    ...
                    >
                        ...
                        <span class="font-medium"
                            >{localSettings.compressionLevel}%</span
                        >
                ...
                <div class="flex items-start space-x-2">
                    ...
                    <div class="text-sm">
                        ...
                        <ul class="mt-2 space-y-1 text-base-content/70">
                            <li>
                                • Shortcuts work globally when not typing in
                                input fields
                            </li>
                            <li>
                                • Press <kbd class="kbd kbd-xs">F1</kbd> anytime
                                to see all shortcuts
                            </li>
                            <li>
                                • Press <kbd class="kbd kbd-xs">Esc</kbd> to clear
                                global color buffer
                            </li>
                            <li>
